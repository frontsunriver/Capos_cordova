...
export class ColorPicker implements OnInit, AfterViewInit{
  ...
  public ngOnInit() {
    ...
    if(this.color){
      ...
      this.color = this.colorFromChooser = "#0000FF";
    }
    //this.init();
  }
  ...
  initPalette(){
    ...
    this.ctxPalette.canvas.style.width = '100%';//width + "px";
  ...
  initChooser(){
    ...
    ctx.canvas.style.width = '100%';//width + "px";
  ...
  apply() {
    this.popoverController.dismiss({process: true, color: this.color});
  }
}
