...
@Component({
  selector: 'app-add-to-bundle',
  templateUrl: './add-to-bundle.component.html',
  styleUrls: ['./add-to-bundle.component.scss'],
})
export class AddToBundleComponent implements OnInit {
  ...
  selProduct(p:IProduct) {    
    ...
    this.bundleService.addProduct(product);
    this.toastService.show('Added to bundle successfully');
  }
